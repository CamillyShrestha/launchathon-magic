...
export default function DoctorDashboard() {
  ...
  const handleClick = () => {
    window.location.href = '/doctor-patient-view'
  }
  useEffect(() => {
    const predefinedPatients: Patient[] = [
      {
        id: "p001",
        lastName: "Smith",
        firstName: "John",
          ...
          {patients.map((patient) => (
            ...
            >
              ...
              <div className="bg-gray-50 px-6 py-4">
                <button onClick={handleClick} className="text-blue-600 hover:text-blue-800 font-medium text-sm transition-colors duration-200">
                  View Profile →
                </button>
              </div>
            </div>
